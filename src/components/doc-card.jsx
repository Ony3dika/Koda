  ...
  return (
    <Card>
      <CardHeader className={"flex justify-between items-center"}>
        <CardTitle className={"truncate py-1.5"}>{doc.title}</CardTitle>
      ...
      <CardContent>
        <CardDescription className={"truncate"}>{doc.description}</CardDescription>
      </CardContent>
      ...
      <CardFooter>
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                  <Button
                    ...
                    variant={"ghost"}
                    className={
                      "w-full justify-start px-0 text-sm py-1.5 flex items-center gap-2"
                    }
                    onClick={() => {
                      setDocumentData({
                        title: doc.title,
        ...
        <div className='mt-5 flex items-center justify-between'>
          ...
          <Badge className={"text-muted-foreground"} variant={"outline"}>
            ...
            {userID === doc.owner_id ? "Author" : "Collaborator"}
          </Badge>
          <Badge
            style={{
